...
namespace Bve5Parser.MapGrammar.V2.AstNodes
{
	...
	internal class RootNode : MapGrammarAstNodes
	{
		...
		public MapV2GrammarParser.EncodingContext Encoding { get; set; }
	...
	internal abstract class InfixExpressionNode : MapGrammarAstNodes
	{
		...
		protected InfixExpressionNode(IToken start, IToken stop) : base(start, stop) { }
	}
	...
	internal abstract class SingleArgFunctionNode : MapGrammarAstNodes
	{
		...
		protected SingleArgFunctionNode(IToken start, IToken stop) : base(start, stop) { }
	}
	...
	{
		public MapV2GrammarParser.StringContext Value { get; set; }
